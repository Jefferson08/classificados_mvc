CREATE DATABASE  IF NOT EXISTS `projeto_classificados` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `projeto_classificados`;
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: localhost    Database: projeto_classificados
-- ------------------------------------------------------
...
INSERT INTO `categorias` VALUES (1,'Relógios'),(2,'Roupas'),(3,'Eletrônicos'),(4,'Carros');
...
-- Dump completed on 2018-11-14 11:23:38
